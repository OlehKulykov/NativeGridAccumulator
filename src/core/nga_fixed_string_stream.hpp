...
#ifndef __NGA_FIXED_STRING_STREAM_HPP__
#define __NGA_FIXED_STRING_STREAM_HPP__ 1
...
namespace nga {
    ...
    private:
        ...
        FixedStringStream & append(const char * NGA_NONNULL str, const size_t len) {
        ...
        FixedStringStream & appendf(const char * NGA_NONNULL format, T v) {
            char buff[BUFF_SIZE];
    ...
    public:
        ...
        FixedStringStream & operator << (const char * NGA_NULLABLE v) {
            const size_t len = v ? ::strlen(v) : 0;
            return (len > 0) ? append(v, len) : *this;
        }
        
        FixedStringStream & operator << (char * NGA_NULLABLE v) {
            const size_t len = v ? ::strlen(v) : 0;
...
#endif //!__NGA_FIXED_STRING_STREAM_HPP__
