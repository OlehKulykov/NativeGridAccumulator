...
#ifndef __NGA_DISPATCH_QUEUE_HPP__
#define __NGA_DISPATCH_QUEUE_HPP__ 1
...
namespace nga {
    ...
    private:
        ...
        static void join(std::thread * NGA_NONNULL threads, const size_t count);
...
#endif //!__NGA_DISPATCH_QUEUE_HPP__
