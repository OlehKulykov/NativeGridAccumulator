...
const char * NGA_NONNULL const emptyCString = "";

char * NGA_NONNULL nga_c_str_copy_non_empty(const char * NGA_NULLABLE cString) {
...
char * NGA_NONNULL nga_c_str_copy_with_empty(const char * NGA_NULLABLE cString) {
    if (cString) {
...
char * NGA_NONNULL nga_c_str_init_len(const size_t len) {
...
void nga_c_str_release(char * NGA_NULLABLE cString) {
    if (cString) {
        free(cString);
    }
}

void nga_c_str_release_zero_fill(char * NGA_NULLABLE cString) {
    if (cString) {
