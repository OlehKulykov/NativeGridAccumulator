...
#include "r2d9_noexcept_unique_lock.hpp"
...
namespace r2d9 {
    ...
    const char * R2D9_NONNULL const loggerTypeDebug     = "DBG";
    ...
    void Logger::log(const char * R2D9_NULLABLE type, const char * R2D9_NULLABLE format, ...) const noexcept {
    ...
    void Logger::systemLog(const int option,
        ...
        ::openlog("r2d9", option, LOG_DAEMON);
